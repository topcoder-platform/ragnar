...
| WEBSITE                                | used as base to construct various URLs     | http://localhost:80            |
...
| TC_USER_PROFILE_URL                    | URL to to call TopCoder API to get profile from token    |  |
...
To access the application, after runnint `npm start` go to `http://localhost:80/app` in your browser.
